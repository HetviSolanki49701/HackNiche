...
List<PlanetInfo> planets = [
  ...
  PlanetInfo(5,
      ...
      iconImage: 'lib/images/article.png',
      description:
  ...
  PlanetInfo(6,
      name: 'CarPool',
      text: 'Use your rewards',
      iconImage: 'lib/images/Carpool.png',
      description:
  ...
  PlanetInfo(7,
      ...
      iconImage: 'lib/images/reward.png',
      description:
  ...
  PlanetInfo(8,
      ...
      iconImage: 'lib/images/dashboard.png',
      description:
